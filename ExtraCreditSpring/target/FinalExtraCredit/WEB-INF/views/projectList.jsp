...
<body>
	...
	<br />
	<br />
	Find Project By Resource
	<form action="findProjectByResource">
		Name: <input type="text" name = "name" /> <input type="submit" value = "Submit"/>
	</form>
	<br />
	Find Project By Location/Keyword
	<form action="findProjectByKeyword">
		Keyword/Location: <input type="text" name = "name" /> <input type="submit" value = "Submit"/>
	</form>
	<br />
	Find Project By Status
	<form action="findProjectByStatus">
		Status: <input type="text" name = "name" /> <input type="submit" value = "Submit"/>
	</form>
	<br />
	Find Project By Volunteer
	<form action="findProjectByVolunteer">
		Volunteer Name: <input type="text" name = "name" /> <input type="submit" value = "Submit"/>
	</form>
</body>
</html>